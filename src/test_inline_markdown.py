...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extraction_images(self):
        images_list = extract_markdown_images("This is text with an ![image](https://i.imgur.com/zjjcJKZ.png) and ![another](https://i.imgur.com/dfsdkjfd.png)")
        self.assertListEqual(
            images_list,
    ...
    def test_extraction_links(self):
        links_list = extract_markdown_links("This is text with a [link](https://www.example.com) and [another](https://www.example.com/another)")
        self.assertListEqual(
            links_list,
